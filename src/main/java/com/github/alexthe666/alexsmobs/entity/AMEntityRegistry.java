...
public class AMEntityRegistry {
    ...
    public static final Holder<EntityType<EntitySeagull>> SEAGULL = register("seagull", () -> registerEntity(FabricEntityTypeBuilder.create(MobCategory.CREATURE, EntitySeagull::new).dimensions(EntityDimensions.fixed(0.45F, 0.45F))));
...
//        event.put(GRIZZLY_BEAR.value(), EntityGrizzlyBear.bakeAttributes().build());
//        event.put(ROADRUNNER.value(), EntityRoadrunner.bakeAttributes().build());
//        event.put(BONE_SERPENT.value(), EntityBoneSerpent.bakeAttributes().build());
//        event.put(BONE_SERPENT_PART.value(), EntityBoneSerpentPart.bakeAttributes().build());
//        event.put(GAZELLE.value(), EntityGazelle.bakeAttributes().build());
        FabricDefaultAttributeRegistry.register(CROCODILE.value(), EntityCrocodile.bakeAttributes().build());
//        event.put(FLY.value(), EntityFly.bakeAttributes().build());
//        event.put(HUMMINGBIRD.value(), EntityHummingbird.bakeAttributes().build());
//        event.put(ORCA.value(), EntityOrca.bakeAttributes().build());
//        event.put(SUNBIRD.value(), EntitySunbird.bakeAttributes().build());
        FabricDefaultAttributeRegistry.register(GORILLA.value(), EntityGorilla.bakeAttributes().build());
//        event.put(CRIMSON_MOSQUITO.value(), EntityCrimsonMosquito.bakeAttributes().build());
//        event.put(RATTLESNAKE.value(), EntityRattlesnake.bakeAttributes().build());
//        event.put(ENDERGRADE.value(), EntityEndergrade.bakeAttributes().build());
        FabricDefaultAttributeRegistry.register(HAMMERHEAD_SHARK.value(), EntityHammerheadShark.bakeAttributes().build());
//        event.put(LOBSTER.value(), EntityLobster.bakeAttributes().build());
...
//        event.put(CENTIPEDE_HEAD.value(), EntityCentipedeHead.bakeAttributes().build());
//        event.put(CENTIPEDE_BODY.value(), EntityCentipedeBody.bakeAttributes().build());
//        event.put(CENTIPEDE_TAIL.value(), EntityCentipedeTail.bakeAttributes().build());
//        event.put(WARPED_TOAD.value(), EntityWarpedToad.bakeAttributes().build());
//        event.put(MOOSE.value(), EntityMoose.bakeAttributes().build());
//        event.put(MIMICUBE.value(), EntityMimicube.bakeAttributes().build());
//        event.put(RACCOON.value(), EntityRaccoon.bakeAttributes().build());
//        event.put(BLOBFISH.value(), EntityBlobfish.bakeAttributes().build());
//        event.put(SEAL.value(), EntitySeal.bakeAttributes().build());
//        event.put(COCKROACH.value(), EntityCockroach.bakeAttributes().build());
//        event.put(SHOEBILL.value(), EntityShoebill.bakeAttributes().build());
//        event.put(ELEPHANT.value(), EntityElephant.bakeAttributes().build());
//        event.put(SOUL_VULTURE.value(), EntitySoulVulture.bakeAttributes().build());
//        event.put(SNOW_LEOPARD.value(), EntitySnowLeopard.bakeAttributes().build());
//        event.put(SPECTRE.value(), EntitySpectre.bakeAttributes().build());
//        event.put(CROW.value(), EntityCrow.bakeAttributes().build());
//        event.put(ALLIGATOR_SNAPPING_TURTLE.value(), EntityAlligatorSnappingTurtle.bakeAttributes().build());
//        event.put(MUNGUS.value(), EntityMungus.bakeAttributes().build());
//        event.put(MANTIS_SHRIMP.value(), EntityMantisShrimp.bakeAttributes().build());
//        event.put(GUSTER.value(), EntityGuster.bakeAttributes().build());
//        event.put(WARPED_MOSCO.value(), EntityWarpedMosco.bakeAttributes().build());
//        event.put(STRADDLER.value(), EntityStraddler.bakeAttributes().build());
//        event.put(STRADPOLE.value(), EntityStradpole.bakeAttributes().build());
//        event.put(EMU.value(), EntityEmu.bakeAttributes().build());
//        event.put(PLATYPUS.value(), EntityPlatypus.bakeAttributes().build());
//        event.put(DROPBEAR.value(), EntityDropBear.bakeAttributes().build());
//        event.put(TASMANIAN_DEVIL.value(), EntityTasmanianDevil.bakeAttributes().build());
//        event.put(KANGAROO.value(), EntityKangaroo.bakeAttributes().build());
//        event.put(CACHALOT_WHALE.value(), EntityCachalotWhale.bakeAttributes().build());
        FabricDefaultAttributeRegistry.register(LEAFCUTTER_ANT.value(), EntityLeafcutterAnt.bakeAttributes().build());
//        event.put(ENDERIOPHAGE.value(), EntityEnderiophage.bakeAttributes().build());
//        event.put(BALD_EAGLE.value(), EntityBaldEagle.bakeAttributes().build());
//        event.put(TIGER.value(), EntityTiger.bakeAttributes().build());
//        event.put(TARANTULA_HAWK.value(), EntityTarantulaHawk.bakeAttributes().build());
//        event.put(VOID_WORM.value(), EntityVoidWorm.bakeAttributes().build());
//        event.put(VOID_WORM_PART.value(), EntityVoidWormPart.bakeAttributes().build());
//        event.put(FRILLED_SHARK.value(), EntityFrilledShark.bakeAttributes().build());
//        event.put(MIMIC_OCTOPUS.value(), EntityMimicOctopus.bakeAttributes().build());
        FabricDefaultAttributeRegistry.register(SEAGULL.value(), EntitySeagull.bakeAttributes().build());
//        event.put(FROSTSTALKER.value(), EntityFroststalker.bakeAttributes().build());
//        event.put(TUSKLIN.value(), EntityTusklin.bakeAttributes().build());
//        event.put(LAVIATHAN.value(), EntityLaviathan.bakeAttributes().build());
//        event.put(COSMAW.value(), EntityCosmaw.bakeAttributes().build());
//        event.put(TOUCAN.value(), EntityToucan.bakeAttributes().build());
//        event.put(MANED_WOLF.value(), EntityManedWolf.bakeAttributes().build());
...
//        event.put(FLUTTER.value(), EntityFlutter.bakeAttributes().build());
//        event.put(GELADA_MONKEY.value(), EntityGeladaMonkey.bakeAttributes().build());
//        event.put(JERBOA.value(), EntityJerboa.bakeAttributes().build());
//        event.put(TERRAPIN.value(), EntityTerrapin.bakeAttributes().build());
//        event.put(COMB_JELLY.value(), EntityCombJelly.bakeAttributes().build());
//        event.put(COSMIC_COD.value(), EntityCosmicCod.bakeAttributes().build());
//        event.put(BUNFUNGUS.value(), EntityBunfungus.bakeAttributes().build());
//        event.put(BISON.value(), EntityBison.bakeAttributes().build());
//        event.put(GIANT_SQUID.value(), EntityGiantSquid.bakeAttributes().build());
//        event.put(SEA_BEAR.value(), EntitySeaBear.bakeAttributes().build());
//        event.put(DEVILS_HOLE_PUPFISH.value(), EntityDevilsHolePupfish.bakeAttributes().build());
//        event.put(CATFISH.value(), EntityCatfish.bakeAttributes().build());
//        event.put(FLYING_FISH.value(), EntityFlyingFish.bakeAttributes().build());
//        event.put(SKELEWAG.value(), EntitySkelewag.bakeAttributes().build());
//        event.put(RAIN_FROG.value(), EntityRainFrog.bakeAttributes().build());
//        event.put(POTOO.value(), EntityPotoo.bakeAttributes().build());
//        event.put(MUDSKIPPER.value(), EntityMudskipper.bakeAttributes().build());
//        event.put(RHINOCEROS.value(), EntityRhinoceros.bakeAttributes().build());
//        event.put(SUGAR_GLIDER.value(), EntitySugarGlider.bakeAttributes().build());
//        event.put(FARSEER.value(), EntityFarseer.bakeAttributes().build());
//        event.put(SKREECHER.value(), EntitySkreecher.bakeAttributes().build());
//        event.put(UNDERMINER.value(), EntityUnderminer.bakeAttributes().build());
//        event.put(MURMUR.value(), EntityMurmur.bakeAttributes().build());
//        event.put(MURMUR_HEAD.value(), EntityMurmurHead.bakeAttributes().build());
//        event.put(SKUNK.value(), EntitySkunk.bakeAttributes().build());
        FabricDefaultAttributeRegistry.register(BANANA_SLUG.value(), EntityBananaSlug.bakeAttributes().build());
//        event.put(BLUE_JAY.value(), EntityBlueJay.bakeAttributes().build());
        FabricDefaultAttributeRegistry.register(CAIMAN.value(), EntityCaiman.bakeAttributes().build());
//        event.put(TRIOPS.value(), EntityTriops.bakeAttributes().build());
    }
